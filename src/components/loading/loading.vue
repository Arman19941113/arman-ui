<template>
    <transition name="fade">
        <div v-show="value" ref="root" class="a-loading" :style="{ position: global && 'fixed', 'z-index': index, background }" @click.stop>
            ...
            <!-- 普通圆弧 -->
            <svg v-else-if="type === 'linear'" :style="computedSize" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- 扩散圆圈 -->
            <div v-else-if="type === 'wave'" :style="computedSize" class="wave-loading"></div>
            <!-- 四点旋转 -->
            <div v-else-if="type === 'dots'" :style="computedSize" class="dots-loading">
